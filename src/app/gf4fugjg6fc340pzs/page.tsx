...
export default async function Page({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10 px-4">
      <div className="w-full max-w-2xl shadow-xl rounded-2xl flex flex-col overflow-hidden border border-gray-200 text-black">
          ...
          <ul className="space-y-4">
            {entries.map((entry: logEntry) => (
              ...
              >
                ...
                <div className="mb-2">
                  <strong className="text-indigo-600">Answered: </strong>
                  {entry.answered ? (
